...
describe(
  "Dashboard Module - getDashboardPayload (PGLite)",
  { timeout: TIMEOUT },
  () => {
    ...
    it("returns correct payload for EMPLOYEE role", async () => {
      ...
      expect(payload.config.subtitle).toBe(
