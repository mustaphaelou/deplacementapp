        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid gap-4 sm:gap-2 sm:grid-cols-2">
            <div className="space-y-2">
              ...
              {errors.dateDepart && <p className="text-xs text-destructive">{errors.dateDepart.message}</p>}
            </div>
            <div className="space-y-2">
              <Label htmlFor="dateRetour">Date de retour</Label>
              <Input id="dateRetour" type="date" {...register("dateRetour")} />
              {errors.dateRetour && <p className="text-xs text-destructive">{errors.dateRetour.message}</p>}
            </div>
          </div>

          <div className="space-y-2">
            <Label htmlFor="destination">Destination</Label>
            <Input id="destination" placeholder="Ville, lieu..." {...register("destination")} />
